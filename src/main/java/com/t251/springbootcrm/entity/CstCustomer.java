...
public class CstCustomer implements Serializable {
        ...
        public String getCustLicence_no() {
            return custLicence_no;
        }

        public void setCustLicence_no(String custLicence_no) {
            this.custLicence_no = custLicence_no;
        }
